...
def fetch_lyrics(song):
	...
	r = requests.get(url,headers={'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.343 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.43'})
